 ...
 */
public class goBILDA_RGB_Continuous {

    private final CRServo rgbServo;
     ...
     */
    public goBILDA_RGB_Continuous(HardwareMap hardwareMap, String deviceName) {
        rgbServo = hardwareMap.get(CRServo.class, deviceName);
    }
